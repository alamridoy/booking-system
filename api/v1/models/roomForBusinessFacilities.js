...
const queries = require('../queries/roomForBusinessFacilities')
...
let getByTitle = async (title = "") => {
    return new Promise((resolve, reject) => {
        connectionHotelPool.query(queries.getByTitle(), [title], (error, result, fields) => {
            if (error) reject(error)
            else resolve(result)
        });
    });
...
let getDataByBusinessTypeId = async (room_id = 0) => {
    return new Promise((resolve, reject) => {
        connectionHotelPool.query(queries.getDataByBusinessTypeId(), [room_id], (error, result, fields) => {
            if (error) reject(error)
            else resolve(result)
        });
    });
...
// let getByRoomId = async (room_id=0) => {
//     return new Promise((resolve, reject) => {
//         connectionHotelPool.query(queries.getByRoomId(), [room_id], (error, result, fields) => {
//             if (error) reject(error)
//             else resolve(result)
//         });
//     });
...
let addNewRoomForBusinessData = async (info, conn = undefined) => {
    let connection = connectionHotelPool;
    if (conn !== undefined) connection = conn;
    
    return new Promise((resolve, reject) => {
        connection.query(queries.addNewRoomForBusinessData(), [info], (error, result, fields) => {
            if (error) reject(error)
            else resolve(result)
        });
    });
...
///
let updateById = async (id = 0, deleted = {}, conn = undefined) => {
    ...
    // for update data
    let keysOfUpdateData = Object.keys(deleted);
    let dataParameterUpdateData = [];

    for (let index = 0; index < keysOfUpdateData.length; index++) {
        dataParameterUpdateData.push(deleted[keysOfUpdateData[index]]);
    }
    ...
    return new Promise((resolve, reject) => {
        connection.query(queries.updateById(deleted), [...dataParameterUpdateData, id], (error, result, fields) => {
            if (error) reject(error);
            else resolve(result);
...
let updateBybusinessId = async (id = 0, updateData = {}, conn = undefined) => {
    ...
    return new Promise((resolve, reject) => {
        connection.query(queries.updateBybusinessId(updateData), [...dataParameterUpdateData, id], (error, result, fields) => {
            if (error) reject(error);
            else resolve(result);
        });
    });
...
let updateDataForBusinessFacilitiesId = async (id = 0, updateDataForBusinessFacilities = {}, conn = undefined) => {
    ...
    // for update data
    let keysOfUpdateData = Object.keys(updateDataForBusinessFacilities);
    let dataParameterUpdateData = [];

    for (let index = 0; index < keysOfUpdateData.length; index++) {
        dataParameterUpdateData.push(updateDataForBusinessFacilities[keysOfUpdateData[index]]);
    }

    return new Promise((resolve, reject) => {
        connection.query(queries.updateDataForBusinessFacilitiesId(updateDataForBusinessFacilities), [...dataParameterUpdateData, id], (error, result, fields) => {
            if (error) reject(error);
            else resolve(result);
        });
    });
...
let getDetailsByIdAndWhereIn = async (business_facilities_types_id = []) => {
    return new Promise((resolve, reject) => {
        connectionHotelPool.query(queries.getDetailsByIdAndWhereIn(), [business_facilities_types_id], (error, result, fields) => {
            if (error) reject(error)
            else resolve(result)
        });
    });
...
let addNewRoomForBusiness = async (info = [], conn) => {
    let connection = connectionHotelPool;
    if (conn !== undefined) connection = conn;

    return new Promise((resolve, reject) => {
        connection.query(queries.addNewRoomForBusiness(), [info], (error, result, fields) => {
            if (error) reject(error)
            else resolve(result)
        });
    });
...
module.exports = {
    ...
    addNewRoomForBusiness,
    // getByRoomId
    getDataByBusinessTypeId,
    addNewRoomForBusinessData,
    updateDataForBusinessFacilitiesId,
    updateBybusinessId
}
