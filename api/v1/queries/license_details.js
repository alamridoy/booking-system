...
let table_name = "license_details";
...
let getLicenseDetailsById = () => {
    return `SELECT paid_expiry,users_license_purchased,trial_type,trial_expiry,paid,paid_type FROM ${table_name} where  id = ? and status != 0`;
}
